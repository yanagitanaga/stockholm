const clients = [
  ...
  { name: 'Живой Трейдер', subs: '30K', niche: 'Finance', platform: 'Meta' },
  { name: 'Усатый Арбитражник', subs: '22K', niche: 'Marketing', platform: 'YouTube' },
  { name: 'Spiry', subs: '19K', niche: 'Technologies / AI', platform: 'Meta / TikTok' },
  { name: 'Movies Explained', subs: '86K', niche: 'Movies', platform: 'YouTube' },
  { name: 'Music Explained', subs: '16K', niche: 'Music', platform: 'YouTube' },
  { name: 'Rap Thread', subs: '42K', niche: 'Music', platform: 'YouTube' },
  { name: 'Wishmaster', subs: '55K', niche: 'Technologies / AI', platform: 'YouTube' },
  { name: 'irwwwin', subs: '68K', niche: 'Movies', platform: 'YouTube' },
  { name: 'ADDIS', subs: '3K', niche: 'Entertainment', platform: 'YouTube' },
  { name: 'ESN Golf', subs: '35K', niche: 'Sports', platform: 'YouTube' },
  { name: 'yuri.ai', subs: '92K', niche: 'Technologies / AI', platform: 'Meta / TikTok' },
